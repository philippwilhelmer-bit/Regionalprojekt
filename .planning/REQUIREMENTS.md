...
- [ ] **MAP-03**: System fetches basemap.at tiles at computed XYZ coordinates and stitches them into a single image using sharp
- [ ] **MAP-04**: System auto-selects zoom level (10–15) based on Nominatim result type (city→12, town→13, village→14, street→15)
- [ ] **MAP-05**: System selects map layer based on article topic keywords (greyscale default, terrain for nature, aerial for infrastructure)
- [ ] **MAP-06**: System stores generated map image in Vercel Blob and writes URL to Article.imageUrl
- [ ] **MAP-07**: System sets Article.imageCredit to "© basemap.at" for all generated map images (CC-BY 4.0 compliance)
- [ ] **MAP-08**: System falls back gracefully to gradient (imageUrl remains null) when location extraction, geocoding, or tile fetching fails

### Pipeline Integration

- [ ] **INTG-01**: System automatically generates map image after AI article generation during cron ingestion pipeline
- [ ] **INTG-02**: Map generation failure never blocks article creation or publication
