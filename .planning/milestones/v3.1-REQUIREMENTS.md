# Requirements Archive: v3.1 Basemap Article Images
...
- [x] **CMS-01**: Editor can preview, regenerate, and override map images via a "Karte" tab alongside existing Unsplash picker
