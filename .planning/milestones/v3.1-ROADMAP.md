...
- [x] **Phase 42: On-Demand Route, CMS Picker, and Backfill** - API route, CMS map picker tab, bulk backfill action (completed 2026-05-10)
...
**Plans:** 2 plans
Plans:
- [x] 42-01-PLAN.md — On-demand route handler, generateMapForArticle and backfillMapImages Server Actions with tests
- [x] 42-02-PLAN.md — MapPicker, ImagePickerTabs, BackfillButton components wired into CMS edit and list pages
...
| 42. On-Demand Route, CMS Picker, and Backfill | 2/2 | Complete    | 2026-05-10 | - |
