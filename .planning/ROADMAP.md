...
- [x] 26-02-PLAN.md — Border-to-tonal migration, corner radius, organic spacing, CTA gradient
- [x] 26-03-PLAN.md — Brand rename (Ennstal Aktuell to Wurzelwelt) and Wurzelmann mascot asset
